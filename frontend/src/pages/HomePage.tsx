...
const HomePage = () => {
  ...
  return (
    <>
          ...
          <div className='grid md:grid-cols-2 gap-16 items-center'>
            <div>
              ...
              <div className='space-y-6 text-lg text-on-surface-variant leading-relaxed font-light'>
                <p>
                  ProjectG is a full-stack event ticketing platform built by a
                  team of students as part of a software engineering project. We
                  set out to design and build a real-world system — from
                  database to UI — that handles the complete lifecycle of event
                  ticketing.
                </p>
                <p>
                  The platform supports customers browsing and purchasing
                  tickets, sellers processing sales at the counter, and
                  administrators managing the system. Every order is fully
                  traceable, every role carefully scoped — built the way a
      ...
      <section id="events" className='py-24 bg-surface-container-low'>
        <div className='max-w-screen-2xl mx-auto px-6'>
          ...
          {!loading && !error && filteredEvents.length === 0 && (
            <div className='text-center py-24 text-on-surface-variant'>
              {q ? `No events found for "${searchParams.get('q')}"` : 'No events found.'}
            </div>
          )}
